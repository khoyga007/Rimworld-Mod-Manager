...
*   **Sắp xếp thông minh (Smart Sort)**: Sử dụng thuật toán DAG kết hợp luật cộng đồng RimPy để tối ưu load order. Tự động nhận diện và phân nhóm (Harmony → Core → DLC → Thư viện → Hiệu năng) giúp game chạy ổn định nhất.
